...
<body>
	...
	<div id="site">
		<header id="masthead">
			<h1>
				Spring Food System <span class="tagline">Food Order System
			</h1>
		</header>
		<div id="content">

			<form action="" method='post' width='200px'>
				Please select a type: <select id='category'>
					...
					<c:if test="${not empty menus}">
						<c:forEach var="item" items="${menus}">
							<li id="productlist">
								...
								<div class="product-description" data-name=${item.name
...
//        $('.add-to-cart').click(function () {
	...
	<footer id="site-info"> Copyright &copy; Spring Corp </footer>
